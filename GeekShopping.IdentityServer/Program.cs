...
IDbInitializer dbInitializer = app.Services.CreateAsyncScope().ServiceProvider.GetService<IDbInitializer>();
...
app.UseIdentityServer();  //tem q ser entre Roputing e Authorization
